...
const file_storage_admin_controller_1 = require("./file-storage.admin.controller");
const config_1 = require("@nestjs/config");
const common_2 = require("../../common/src");
const Minio = __importStar(require("minio"));
const file_storage_public_controller_1 = require("./file-storage.public.controller");
